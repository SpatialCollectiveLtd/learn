...
async function movePaulToMicrotaskingCorrect() {
  const pool = new Pool({
  ...
  try {
    ...
    // First, check Paul's current status
    ...
    console.log(`   Name: ${paul.full_name}`);
    ...
    // Count total attendance by program
