...
async function movePaulToMicrotasking() {
  const pool = new Pool({
  ...
  try {
    ...
    const currentStatus = await pool.query(`
      SELECT youth_id, first_name, last_name, program_type, settlement, osm_username
    ...
    console.log(`   Name: ${paul.first_name} ${paul.last_name}`);
    console.log(`   Current Program: ${paul.program_type}`);
    console.log(`   Settlement: ${paul.settlement}`);
    console.log(`   OSM Username: ${paul.osm_username}`);
